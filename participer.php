          ...
          <ol>
            <li>
              <div class="number-container">
                <img class="bulle" src="assets/imgs/bulle.png" alt="">
            ...
            <li>
              ...
              <div class="d-flex flex-column">
                <div class="d-flex align-items-center">
                  <p>
                    Renseignez les codes
                  </p>
                  <span class="ms-1" type="button" data-bs-toggle="modal" data-bs-target="#modal-1">
                    <div class="modal-btn">?</div>
                  </span>
                </div>
                <aside>imprimés au verso de chacun des deux packs</aside>
              </div>
            </li>
            <li class="align-items-center">
              ...
              <div class="d-flex flex-column">
                <p>découvrez si vous avez gagné !</p>
              </div>
            </li>
          </ol>
        </div>
        ...
        <div class="block">
          ...
          <ol>
            <li>
              ...
              <div class="d-flex flex-column">
                <p>Achetez un pack promotionnel Mamie nova</p>
                <aside>
                  des gammes Yaourt aux fruits, Crème ou Fondant dans l’un des magasins participants à l’opération.
                  <span type="button" data-bs-toggle="modal" data-bs-target="#modal-2">
                    <div class="modal-btn">?</div>
                  </span>
                </aside>
                <div class="carousel">
            ...
            <li class="align-items-center">
              ...
              <div class="d-flex flex-column">
                <p>Téléchargez votre ticket de caisse</p>
              </div>
            </li>
            <li class="align-items-center">
              <div class="number-container">
              ...
              <div class="d-flex flex-column">
                <p>inscrivez-vous au tirage au sort
                </p>
              </div>
            </li>
          </ol>
