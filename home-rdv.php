...
<div class="layout home">
  ...
  <a href="question-1.php" class="btn btn-primary d-none d-md-block mx-auto mb-5 mb-xl-3 mt-xxl-5">rendez-vous le 31 janvier 2022 !</a>
  <div class="mt-auto d-flex flex-column flex-xl-row-reverse justify-content-xl-end align-items-xl-end">
    ...
    <div class="container d-md-none">
      <button class="btn btn-primary mx-auto mt-5">rendez-vous le 31 janvier 2022 !</button>
    </div>
    <div class="d-md-none">
